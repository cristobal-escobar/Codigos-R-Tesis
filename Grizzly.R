...
#Importar Datos de Excel de Grizzly
datos<- read_excel(ruta_excel,sheet = "Grizzly")
...
hist(falla_E, prob = TRUE, ylim = c(0,max_y2), main ="Comparación de distribuciones", ylab = "Densidad", xlab = "Horas")
...
par(mfrow = c(1,1), mar = c(4,4,2,1))
max_y3 <- max(hist(falla_O, plot=FALSE)$density, den_log7)
hist(falla_O, prob = TRUE, ylim = c(0,max_y3), main ="Comparación de distribuciones", ylab = "Densidad",xlab = "Horas")
