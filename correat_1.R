...
#Importar Datos de Excel de Correa 
datos<- read_excel(ruta_excel,sheet = "Correa T-1")
...
lines(tiempos_2,den_log2,col = "red",lwd = 2)
par(mfrow = c(1,1), mar = c(4,4,2,1))
...
lines(tiempos_2, den_exp2, col = "purple", lwd = 2)
legend("topright",
       legend = c("Weibull", "Normal", "Lognormal", "Exponencial"),
       col = c("red", "blue", "green", "purple"),
       lwd = 2)
...
# Histograma
par(mfrow = c(1,1), mar = c(4,4,2,1))
hist(falla_E, prob = TRUE, main ="Histograma y curva aproximada", ylab = "Densidad")
lines(tiemposF_1,den_gamma4,col = "red",lwd = 2)
par(mfrow = c(1,1), mar = c(4,4,2,1))
hist(falla_E, prob = TRUE, col = "lightgray",
     main = "Comparación de distribuciones",
     xlab = "Horas", ylab = "Densidad")
...
par(mfrow = c(1,1), mar = c(4,4,2,1))
hist(falla_M, prob = TRUE, col = "lightgray",
     main = "Comparación de distribuciones",
     xlab = "Horas", ylab = "Densidad")
lines(tiemposF_2, den_log5, col = "red", lwd = 2)
...
# Histograma
par(mfrow = c(1,1), mar = c(4,4,2,1))
max_y2 <- max(hist(falla_I, plot=FALSE)$density, den_log6)
hist(falla_I, breaks = 20,prob = TRUE, ylim = c(0,max_y2), main ="Comparación de distribuciones", ylab = "Densidad",xlab = "Horas")
...
# Histograma
par(mfrow = c(1,1), mar = c(4,4,2,1))
hist(falla_O, breaks = 10, prob = TRUE, main ="Histograma y curva aproximada", ylab = "Densidad")
lines(tiemposF_4,den_gamma7,col = "red",lwd = 2)
par(mfrow = c(1,1), mar = c(4,4,2,1))
...
# Histograma
par(mfrow = c(1,1), mar = c(4,4,2,1))
hist(falla_MA, prob = TRUE, main ="Histograma y curva aproximada", ylab = "Densidad")
